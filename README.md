...
# Awesome WezTerm [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 445,551 | 🐛 81 | 📅 2026-03-09 with stars

<img src="https://raw.githubusercontent.com/wez/wezterm/main/assets/icon/wezterm-icon.svg" align="right" width="144" />

> Collections of awesome WezTerm plugins. [Plugin Guide](https://github.com/wezterm/wezterm/blob/main/docs/config/plugins.md) ⭐ 24,866 | 🐛 1,629 | 🌐 Rust | 📅 2026-03-01. Found something cool? Please [contribute](origin/CONTRIBUTING.md)!
...
* [Eric162/wezterm-agent-deck](https://github.com/Eric162/wezterm-agent-deck) ⭐ 32 | 🐛 0 | 🌐 Lua | 📅 2026-01-20 - Monitors AI coding agents, shows status dots in tabs and notifications when agents need attention.
* [Michal1993r/ai-helper.wezterm](https://github.com/Michal1993r/ai-helper.wezterm/tree/master) ⭐ 29 | 🐛 0 | 🌐 Lua | 📅 2026-03-13 - Ask AI for CLI help with LM Studio or Google Gemini.
...
* [mrjones2014/smart-splits.nvim](https://github.com/mrjones2014/smart-splits.nvim) ⭐ 1,587 | 🐛 14 | 🌐 Lua | 📅 2026-03-13 - Provides an addon for seamless pane navigation between Neovim and the WezTerm MUX.
...
* [abidibo/wezterm-sessions](https://github.com/abidibo/wezterm-sessions) ⭐ 16 | 🐛 1 | 🌐 Lua | 📅 2026-03-11 - Save and restore sessions.
...
* [adriankarlen/bar.wezterm](https://github.com/adriankarlen/bar.wezterm) ⭐ 211 | 🐛 2 | 🌐 Lua | 📅 2026-03-14 - A configurable tab bar with batteries included.
